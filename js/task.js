...
//             else
//                 return listOfTasks.filter(date => new Date(date) >= new Date(dateFrom));
//         }
//         return listOfTasks.filter(date => new Date(date) >= new Date(dateFrom) && new Date(date) >= new Date(dateTo);
//     }
